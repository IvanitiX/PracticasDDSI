...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 19-01-2020 a las 13:14:01
...
(1, '2020-01-18', 'Alquiler de pistas', 4219),
(9, '2020-01-02', 'nuevas inscripciones', 3400),
(12, '2020-01-08', 'nuevas inscripciones', 2500),
(13, '2020-01-05', 'nuevas inscripciones', 1400),
(38, '2020-01-10', 'Cursos No incluidos en la Tarjeta de socios', 5000),
(45, '2020-01-04', 'Cursos No incluidos en la Tarjeta de socios', 4000),
(53, '2020-01-16', 'Pagos mensuales de clientes', 8000),
(63, '2020-01-06', 'Pagos mensuales de clientes', 900),
(69, '2020-01-01', 'Ganancias del merchandasing', 9931),
(78, '2020-01-19', 'Alquiler de pistas', 6721);
...
INSERT INTO `empleadostrabajan` (`idEmpleado`, `nombre`, `apellidos`, `domicilio`, `IdCentro`, `correo`, `Telefono`, `dni`, `Puesto`, `Jornada`, `Estado`, `Formación`) VALUES
('1', 'Manolo', 'Lama Gutierrez', 'Calle Falsa 123', 'CO0', 'mlama@ok.ru', '633895769', '459336874', 'Uno', 8, 'Activo', 'Universidad Vida'),
('2', 'Rosa', 'Melano Gutierrez', 'Calle Sucasa nº420', 'CO6', 'rmg@okboomer.es', '666666666', '69696969A', 'Mira las cosas', 8, 'baja', 'Universida dela Vida');
...
--
ALTER TABLE `activos`
  ADD CONSTRAINT `activos_ibfk_1` FOREIGN KEY (`ID_Transaccion`) REFERENCES `factura_hace` (`idFactura`);
