        ...
        <div class="inicio container">
            <div class="row">
                <div class="vertical-menu col-lg-2 col-sm-3">
                    ...
                    <a href="./factura.php">Realizar venta</a>
        ...
        <div class="row">
            ...
            <div class="col-lg-3 col-sm-6">
                <form action="../php/Ventas/aniadirTarifa.php" method="post">
                    ...
                    <input type="checkbox" name="zona1" value="Maquinas"> Maquinas <br>
                    <input type="checkbox" name="zona2" value="Piscina"> Piscina
                    <p></p>
            ...
            <div class="col-lg-4 col-sm-6">
                <form style="width:400px">
                    ...
                    <?php
                        ...
                        echo "<th>Cantidad</th>";
                        echo "<th>Precio</th>";
                        echo "<th>Nuevo precio</th>";
                        echo "</tr>";
                        while($columna = mysqli_fetch_array($resultado)){
                            echo "<tr>";
                            echo "<td>" . $columna['IdProducto'] . "</td><td>" . $columna['Descripcion'] . "</td><td>" . $columna['Cantidad'] ."</td><td>" . $columna['Precio'] . "</td><td><input name=" . $columna['Descripcion'] . "\" type=number min=0 max=99999>" 
                            . "</td><td><input type=submit value=Enviar></td>";
                            echo "</tr>";
                        }
                        echo "</table>";
                    ?>
