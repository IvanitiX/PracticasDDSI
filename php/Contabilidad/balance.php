...
<html>
    ...
    <script type="text/javascript">
      ...
      data.addRows([
        ...
        <?php
            //Limites
            $dateini = $_POST['fechaini'] ;
            $datefin = $_POST['fechafin'] ;
        ...
        <div class="inicio container">
            <div class="row">
                <div class="vertical-menu col-lg-4 col-sm-4">
                    <a href="../../../Contabilidad/Contabilidad.html" >Contabilidad</a>
                    <a href="../../../Contabilidad/Activo.php">Activo</a>
                    <a href="../../../Contabilidad/Pasivo.php">Pasivo</a>
                    <a href="../../../Contabilidad/Transaccion.html">Transaccion</a>
                    <a href="../../../Contabilidad/Balance_Economico.html">Balance Economico</a>
                </div>
                <div class="inicio col-lg-6 col-sm-6">
                    <h1>Contabilidad > Resultado</h1>
                </div>
